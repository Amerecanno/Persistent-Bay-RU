...
/datum/category_item/player_setup_item/welcome/content()
    ...
    . += "</font><br><br>"
    . += "<a href='https://discord.gg/ZgjJp7X6ed%27target=%27_blank%27%3EПрисоединиться к Discord</a><br>Discord - это место, где происходит большинство OOC обсуждений, и тонны полезных игроков расскажут вам все о том, как играть в упорство и чем оно отличается."
